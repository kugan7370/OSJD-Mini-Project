  ...
  return (
      <div>
          <div className='bg-black relative'>
              ...
              <div className='absolute top-24 right-0 text-white left-1/2 '>
                  <div className=' flex flex-col space-y-7'>
                      <span className='text-lg'>- YOU WANT IT YOU GOT IT</span>
                      <span className='text-7xl font-bold'>Buy Your Jersy</span>
                      <span className='text-7xl font-bold '>right now</span>
                      <div>
